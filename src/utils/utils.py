...
def med_reshape(image, new_shape):
    ...
    #print(f"New reshaped_image {reshaped_image.shape}")
    #input("Pause 3")

    # TASK: write your original image into the reshaped image
    # reshape the image into reshaped_image
    # the image has the shape [x,y,z == coronal, sagittal, axial]
    x,y,z = image.shape
    reshaped_image[0:x,0:y,0:z] = image[0:x,0:y,0:z]
